...
import gr.kalymnos.sk3m3l10.greekpodcasts.android_views.EpisodePoster;
...
public class EpisodeViewMvcImpl implements EpisodeViewMvc {
    ...
    @Override
    public void setOnEpisodeControlsClickListener(OnEpisodeButtonsClickListener listener) {
        if (listener != null) {
